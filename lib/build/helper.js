...
const resolvePattern = ( pattern, pkg, module, file ) => pattern
...
async function saveFile ( pkg, pattern, file, outDir, content ) {

    const [ module, filename ] = parseFilePath( file );
    const outName = resolvePattern( pattern, pkg, module, filename );
